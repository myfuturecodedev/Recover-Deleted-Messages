...
//class LanguageAdapter(
//    // ✅ CHANGED: Removed Activity context dependency & added a clean callback wrapper for inflation
//    private val onLanguageSelected: (LanguageModel) -> Unit,
...
//        RecyclerView.ViewHolder(binding.root) {
//
//        // ✅ FIXED: Anti-flickering scroll lock mechanism
//        private var isAdInitialized = false
//
//        fun bind() {
//            if (!isAdInitialized) {
//                // ✅ FIXED: Safely passing the child layout view binders straight up to the fragment helper
...
//        override fun areContentsTheSame(oldItem: Any, newItem: Any): Boolean {
//            return if (oldItem is LanguageModel && newItem is LanguageModel) {
//                // ✅ FIXED: Prevents redundant item refresh skips during state mutation checks
//                oldItem.isSelected == newItem.isSelected && oldItem.displayLanguage == newItem.displayLanguage
//            } else {
//                oldItem == newItem
//            }
//        }
